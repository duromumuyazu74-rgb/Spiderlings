...
| [幼蛛猎场总规格 #90](https://github.com/duromumuyazu74-rgb/Spiderlings/issues/90)     | `0.92.36-test.41` | 五巢“幼蛛侵扰”（默认权重 50，任意主派系）与三巢“幼蛛猎场”（默认权重 750，仅女仆主派系）独立存在；普通幼蛛占领猎场，巡逻捕猎不同阵营 NPC |
...
test.41 在原生主派系确定后抽取蜘蛛地图修饰符。侵扰可搭配任意主派系，猎场仅搭配 Maidforce；两者互斥，不改写主派系。Mod 设置中的侵扰和猎场权重默认分别为 50、750，0 关闭对应修饰符，保存后影响新生成的旅程节点。四个参考区域等量抽样时，两者总体出现率均约 5.56%；各区域和实际选路会有差异。详见[参数说明](KinkyDungeon-Spiderlings/Spiderlings_0.9_Parameter_Guide.md#幼蛛猎场楼层)。
