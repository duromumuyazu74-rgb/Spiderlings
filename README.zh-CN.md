...
| [敌方蛛网素材 Issue #86](https://github.com/duromumuyazu74-rgb/Spiderlings/issues/86) | `0.92.36-test.27` | Spinner 陷阱边框与玩家牵引线采用正确的 Normal 图，Pink 图待补 |
...
test.27 在 Spinner 训练场采用 T_Swizzle 正确的 Normal 蛛网边框图，捕获玩家时采用 Normal 牵引线图。粉色模式暂沿用现有线条绘制，等待画师提供真正的 Pink 图。WebCaster 的四种弹体效果已有完整的 Normal/Pink 成对素材。
