...
| [Hunting Grounds spec #90](https://github.com/duromumuyazu74-rgb/Spiderlings/issues/90) | `0.92.36-test.37` | Separate five-nest Infestation (weight 50) and three-nest Hunting Grounds (weight 100), where ordinary Spiderlings patrol for NPCs of a different faction |
