...
| [Hunting Grounds spec #90](https://github.com/duromumuyazu74-rgb/Spiderlings/issues/90) | `0.92.36-test.41` | Separate five-nest Infestation (default weight 50; any primary faction) and three-nest Hunting Grounds (default weight 750; Maidforce only), where ordinary Spiderlings patrol for NPCs of a different faction |
...
Test.41 draws spider modifiers after the native primary faction is resolved. Infestation accepts any primary faction; Hunting Grounds requires Maidforce. They are mutually exclusive and preserve that faction. Their Mod settings default to weights 50 and 750; zero disables a modifier, and saved changes affect newly generated journey nodes. Both average about 5.56% across four equally sampled reference biomes; individual biomes and player routes differ. See the [parameter guide](KinkyDungeon-Spiderlings/Spiderlings_0.9_Parameter_Guide.md#幼蛛猎场楼层).
