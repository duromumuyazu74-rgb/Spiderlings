...
| [Hunting Grounds spec #90](https://github.com/duromumuyazu74-rgb/Spiderlings/issues/90) | `0.92.36-test.42` | Separate five-nest Infestation (default weight 50; any primary faction) and three-nest Hunting Grounds (default weight 1000; Maidforce only), where ordinary Spiderlings patrol for NPCs of a different faction |
