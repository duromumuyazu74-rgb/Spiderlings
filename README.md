...
| [`test`](https://github.com/duromumuyazu74-rgb/Spiderlings/tree/test) | `0.92.36-test.14` | Development and playtesting |
...
Art assets: T_Swizzle. Original mod author: anthropocentricity. Revived and maintained by: Chlorlne. Existing authorship in the manifest and source is preserved.
